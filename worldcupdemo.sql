...
DROP DATABASE worldcupdemo;
--
-- Name: worldcupdemo; Type: DATABASE; Schema: -; Owner: freecodecamp
--

CREATE DATABASE worldcupdemo WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'C.UTF-8' LC_CTYPE = 'C.UTF-8';


ALTER DATABASE worldcupdemo OWNER TO freecodecamp;

\connect worldcupdemo
